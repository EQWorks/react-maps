...
Object.defineProperty(exports, "useReport", {
  enumerable: true,
  get: function get() {
    return _report.useReport;
  }
});
Object.defineProperty(exports, "useFullReport", {
  enumerable: true,
  get: function get() {
    return _report.useFullReport;
  }
});
exports.useTimeline = exports.useRadius = exports.useFill = exports.useElevation = exports.useMapData = exports.useLegends = void 0;
...
var useLegends = function useLegends(_ref) {
  ...
  var legends = (0, _react.useMemo)(function () {
    return (0, _utils.setLegendConfigs)(_objectSpread({
...
var useTimeline = function useTimeline(timestampInit, speedInterval) {
  var _useState7 = (0, _react.useState)(false),
      _useState8 = _slicedToArray(_useState7, 2),
      player = _useState8[0],
      setPlayer = _useState8[1]; // NOTE: reducers should be "pure", so can't manage the player


  var _useReducer3 = (0, _react.useReducer)(function (state, _ref9) {
    var type = _ref9.type,
        payload = _ref9.payload;

    if (type === 'move') {
      var activeIndex = state.activeIndex + 1 * state.direction;

      if (state.direction < 0 && activeIndex <= 0 || state.direction > 0 && activeIndex >= state.timestamps.length - 1) {
    ...
    activeIndex: 0,
    speed: speedInterval,
    timestamps: timestampInit
  }),
      _useReducer4 = _slicedToArray(_useReducer3, 2),
      timeline = _useReducer4[0],
      timelineDispatch = _useReducer4[1];

  var resetPlayer = function resetPlayer(speed) {
    return function (oldPlayer) {
  ...
  var stopTimeline = function stopTimeline() {
    clearInterval(player);
    setPlayer(false);
  };

  var changeSpeed = function changeSpeed(value) {
    return function () {
      timelineDispatch({
        type: 'speed',
        payload: value
